...
DCT_METHODS = ['int']
SUBSAMPLINGS = ['4:2:0'] # For end user viewing purposes, 444 and 422 make no sense
RESTART_INTERVALS = [0, 8] #range(0, 9, 2)
...
df.to_csv('results_libjpeg-turbo_LoLa.csv', index=False)
print("\n✅ Benchmarking complete! Results saved to 'results_libjpeg-turbo_LoLa.csv'")
df.head()
